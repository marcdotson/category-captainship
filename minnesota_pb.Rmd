...
Filter by state and save as Minnesota Peanut Butter file

```{r}
min_pb_data <- full_11_12_13 %>% filter(fips_state_descr == "MN") 

save(min_pb_data, file = "min_pb_data.RData")
