...
Note: This document contains all the code used to merge and clean data, and then produce graphs. Documents in the spreads/jams category for the
...
Unzip file Read in the movement, store and products file for 2011,2012, 2013
```{r results='hide'}
...
rm(full_11, full_12, full_13, in_11_not_12, in_11_not_13, in_12_not_11, in_12_not_13, in_13_not_11, in_13_not_12, move_11,
   move_12, move_13, store_id_11, store_id_12, store_id_13, stores_11, stores_12, stores_13, products)
```
...
```{r}
 ...
 filter(manuf_name %in% c("SMU","SAN","R W", "DIC", "KIN", "CRO", "WEL", "CTL")) %>% mutate(actual_manuf = if_else(manuf_name == "SMU","SMU",if_else(manuf_name == "SAN", "SMU", if_else(manuf_name == "R W", "SMU", if_else(manuf_name == "DIC", "SMU", if_else(manuf_name == "KIN", "SMU", if_else(manuf_name == "CRO", "SMU",if_else(manuf_name == "WEL","WEL","CTL"))))))))
```
