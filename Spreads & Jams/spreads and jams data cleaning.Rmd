...
save(mn_data, file = "mn_spreads_jams_data.RData")
save(nd_data, file = 'nd_spreads_jams_data.RData')
save(mo_data, file = 'mo_spreads_jams_data.RData')
save(dc_data, file = 'dc_spreads_jams_data.RData')
```