...
save(mn_data, file = 'mn_pickles_olives_data.RData')
save(nd_data, file = 'nd_pickles_olives_data.RData')
save(mo_data, file = 'mo_pickles_olives_data.RData')
save(dc_data, file = 'dc_pickles_olives_data.RData')
```