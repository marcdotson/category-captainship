---
title: "Bayesian Synthetic Control with intercept"
author: "Morgan Bale"
date: "10/28/2021"
output: github_document
---

The purpose of this file is to add an intercept and horseshoe priors to the Bayesian synthetic control method tested in `testing_bscm`. The model comes from the web index of the Gupta et al, part B.1 BSCM-Horseshoe. 
