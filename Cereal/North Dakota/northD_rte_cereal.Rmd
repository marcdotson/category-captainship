---
title: "North Dakota RTE Cereal"
output: word_document
---


Note: This document contains only the code necessary to produce the graphs. For full code used to merge and clean the data see 
the 'minnesota_RTE_cereal' file.
...
Load 'main_manuf_sales' file which contains the movement file data for the Captain, Validator, and Private Label.
