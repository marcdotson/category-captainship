---
title: "North Dakota Ice Cream Graph Analysis"
...
```
Load in the North Dakota ice cream cleaned data. Read in `brands` file which contains the parent companies of all brands listed in `nd_data`.
```{r}
load("nd_ice_cream_clean.RData")
