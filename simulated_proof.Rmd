...
Create simulated data by a random draw and add noise each period. Add a 25% increase in sales for the treated retailer in the post treatment period. Choose treatment period at week_end=80, halfway through simulated time periods. 
```{r}
...
Try doing a microsynth loop where each retailer is paired with each other retailer. The retailer that causes the pairs to be significant/positive should be the treated retailer. Aggregate sim data across manufacturers to do synthetic control at the store level. 
```{r}
