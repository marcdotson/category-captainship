---
title: "Missouri Lunchmeat Graph Analysis"
author: "Cameron Bale"
date: "August 13, 2018"
...
```
Load the Missouri lunch meat data file. Read in `brands` file which contains the parent companies of all brands listed in `mo_data`.
```{r}
load("mo_lunchmeat_clean.RData")
