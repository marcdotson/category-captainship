---
title: "Missouri Lunchmeat Market Share Retailer Test"
...
mo_data <- mo_data %>%
  ...
  mutate(actual_manuf = if_else(manuf_name == "OSC", "oscmayer", 'private_label')) %>%
...
msynth_results %>%
  ...
  facet_wrap(~retailer) + labs(x="Treatment Effect", y="Count", title="Manufacturer Level Significant Treatment Effects: MO Lunchmeat", subtitle = "Market Share")
```
...
msynth_results %>%
  ...
  labs(x = 'Effect',
       y = 'Count',
       title = 'Significant Treatment Effects for Retailer Combinations at Manufacturer Level: MO Lunchmeat',
