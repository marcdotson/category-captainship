---
title: "Minnesota Spreads and Jams Market Share Retailer Test"
...
```{r}
load(here::here("..", "mn_spreads_jams_clean.RData"))
```
...
msynth_results %>%
  ...
  facet_wrap(~retailer) + labs(x="Treatment Effect", y="Count", title="Manufacturer Level Significant Treatment Effects: MN Spreads and Jams", subtitle = "Market Share")
```
...
msynth_results %>%
  ...
  labs(x = 'Effect',
       y = 'Count',
       title = 'Significant Treatment Effects for Retailer Combinations at Manufacturer Level: MN Spreads and Jams',
