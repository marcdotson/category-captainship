...
Plotting distributions of p-values at the Manufacturer level.
```{r}
msynth_results %>%
  ggplot(aes(x = pval)) +
  geom_histogram() +
  geom_vline(xintercept = 0, col = 'blue') +
  facet_wrap(~retailer) + labs(x="P-Value", y="Count", title="Manufacturer Level P-Values for MN Spreads/Jams")
```
...
msynth_results %>%
  ...
  labs(x="Treatment Effect", 
       y="Count", 
       title="Manufacturer Level Treatment Effects for MN Spreads/Jams")
```
...
msynth_results %>%
  ...
  labs(x="P-Value", 
       y="Count", 
       title="Store Level P-Values for Retailers in MN Spreads/Jams")
```
...
msynth_results %>%
  ...
  labs(x="Treatment Effect", 
       y="Count", 
       title="Store Level Treatment Effects for MN Spreads/Jams")
```
...
msynth_results %>%
  ...
  labs(x = 'P-Value',
       y = 'Count',
       title = 'P-Values for Retailer Combinations at the Store Level: MN Spreads/Jams')
```
...
msynth_results %>%
  ...
  labs(x = 'Effect',
       y = 'Count',
       title = 'Treatment Effects for Retailer Combinations at Store Level: MN Spreads/Jams')
```
