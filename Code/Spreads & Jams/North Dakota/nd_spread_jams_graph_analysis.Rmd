---
title: "North Dakota Spread and Jam Graph Analysis"
...
```
Load North Dakota cleaned spread and jams data.
```{r}
load('nd_spreads_jams_clean.RData')
```
