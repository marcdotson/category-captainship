---
title: "DC Pickles/Olives Graph Analysis"
...
Load DC data.
```{r}
load('dc_pickles_olives_clean.RData')
```
...
Create `retailer_weekly`, which is filtered for retailers in DC, grouped by retailer code, brand_name, and week_end, creating weekly sales and average prices by manufacturer within retailer. `ret_codes` contains each unique retailer code. 
