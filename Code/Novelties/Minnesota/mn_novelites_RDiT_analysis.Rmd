---
title: "Minnesota Novelties RDiT Analysis"
author: "Morgan Bale"
date: "May 28, 2019"
...
Load data.
```{r}
load(here::here("..", "mn_novel_clean.RData"))
```
...
for (i in seq_along(ret_codes)) {
  ...
  captain_prods <- mn_data %>%
    filter(retailer_code == ret_codes[i] & manuf_name %in% c("BEN", "POP", "GOO", "KLO", "BRE", "FUD", "CHO", "CRE", "MAG", "YOS", 
                                                             "FRU", "TAL")) %>%
