---
title: "Minnesota Novelties Market Share Retailer Test"
...
mn_data <- mn_data %>%
  filter(manuf_name %in% c("BEN", 
                           ...
                           "TAL",
                           "CTL")) %>%
  mutate(actual_manuf = if_else(manuf_name == "CTL", "private_label", "unilever")) %>%
...
msynth_results %>%
  ...
  facet_wrap(~retailer) + labs(x="Treatment Effect", y="Count", title="Manufacturer Level Significant Treatment Effects: MN Novelties", subtitle = "Market Share")
```
...
msynth_results %>%
  ...
  labs(x = 'Effect',
       y = 'Count',
       title = 'Significant Treatment Effects for Retailer Combinations at Manufacturer Level: MN Novelties',
