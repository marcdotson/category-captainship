---
title: "North Dakota Canned Soup Graph Analysis"
...
Load in the North Dakota canned soup data. Read in `brands` file which contains the parent companies of all brands listed in `full_11_12_13`.
```{r}
load("nd_can_soup_clean.RData")
