---
title: "North Dakota Cereal Graph Analysis"
output: github_document
---

Note: This document contains only the code necessary to produce the graphs. For full code used to merge and clean the data see the cereal cleaning file. 
