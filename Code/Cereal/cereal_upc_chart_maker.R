...
rm(full_11, full_12, full_13, in_11_not_12, in_11_not_13, in_12_not_11, in_12_not_13, in_13_not_11, in_13_not_12, move_13,
   store_id_11, store_id_12, store_id_13, stores_13, products, i, pick_olive_files, products)
...
save(full_11_12_13, file = "full_11_12.RData")
...
for (i in seq_along(state_abbrevs)) {
  ...
  for (j in seq_along(rets)) {
    ...
    sales_table <- datatable(chart_data, caption = paste("Cereal Sales for Retailer", rets[j], "in", state_abbrevs[i])) %>% 
