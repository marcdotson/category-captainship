---
title: "Missouri Ice Cream Graph Analysis"
...
```
Load in the Missouri ice cream cleaned data. Read in `brands` file which contains the parent companies of all brands listed in `mo_data`.
```{r}
load("mo_ice_cream_clean.RData")
