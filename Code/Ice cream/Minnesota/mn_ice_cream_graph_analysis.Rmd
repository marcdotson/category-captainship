---
title: "Minnesota Ice Cream Graph Analysis"
output: github_document
---

Note: This document contains all the code used to produce the graphs for the ice cream category in Minnesota. 
...
Load in the Minnesota ice cream cleaned data. Read in `brands` file which contains the parent companies of all brands listed in `mn_data`.
```{r}
