---
title: "DC Lunchmeat Graph Analysis"
author: "Cameron Bale"
date: "August 13, 2018"
...
```
Load the DC lunch meat data. Read in `brands` file which contains the parent companies of all brands listed in `dc_data`. 
```{r}
load("dc_lunchmeat_clean.RData")
