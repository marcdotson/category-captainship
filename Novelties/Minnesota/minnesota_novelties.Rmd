---
title: "Minnesota Novelties"
output: word_document
---


Note: This document contains all the code used to merge and clean data, and then produce graphs. Documents in the novelties category for the
