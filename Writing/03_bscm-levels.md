...
Run model using `bscm_level1.stan`.

``` r
b1_model <- stan_model(file = here::here("Code", "Model", "bscm_level1.stan"))
```
...
![](../Figures/bscm/levels-recovery-1.png)<!-- -->

``` r
traceplot(draws, pars="beta") #(S,B)
```

![](../Figures/bscm/levels-recovery-2.png)<!-- -->

``` r
traceplot(draws, pars="sigma")
```

![](../Figures/bscm/levels-recovery-3.png)<!-- -->

``` r
traceplot(draws, pars="lambda") #(S,B)
```

![](../Figures/bscm/levels-recovery-4.png)<!-- -->

``` r
traceplot(draws, pars="tau")
```

![](../Figures/bscm/levels-recovery-5.png)<!-- -->
...
![](../Figures/bscm/levels-recovery-6.png)<!-- -->
...
![](../Figures/bscm/levels-recovery-7.png)<!-- -->
...
![](../Figures/bscm/levels-pre-treatment-1.png)<!-- -->
...
![](../Figures/bscm/levels-post-period-1.png)<!-- -->
...
![](../Figures/bscm/levels-brand-01-1.png)<!-- -->
...
![](../Figures/bscm/levels-brand-02-1.png)<!-- -->
...
![](../Figures/bscm/levels-brand-03-1.png)<!-- -->
