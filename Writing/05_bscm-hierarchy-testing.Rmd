...
sim_theta0 <- extract(sim_data)$theta_0    #intercept in alpha equation  
...
traceplot(draws, pars=c("theta_0[1]", "theta_0[2]", "theta_0[3]", "theta_0[4]"))
...
mcmc_recover_hist(As.mcmc.list(draws, pars="theta_0[1]"), true=b1_data$theta_0[1])
mcmc_recover_hist(As.mcmc.list(draws, pars="theta_0[2]"), true=b1_data$theta_0[2])
mcmc_recover_hist(As.mcmc.list(draws, pars="theta_0[3]"), true=b1_data$theta_0[3])
